...
object Constants {
    ...
    const val CAT_VITAMINS: String = "Cat Vitamins"
    const val CAT_SUPLEMENTS: String = "Cat Suplements"
    const val CAT_MEDICINE: String = "Cat Medicine"

    const val DOG_VITAMINS: String = "Dog Vitamins"
